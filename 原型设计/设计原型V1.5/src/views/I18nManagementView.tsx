    ...
    <div style={{ maxWidth: 1440, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <button className="btn-secondary" style={{ fontSize: 12.5 }}><Download size={13} />导出 JSON</button>
          <button className="btn-secondary" style={{ fontSize: 12.5 }}><Upload size={13} />导入</button>
          {modifiedCount > 0 && (
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '196px 1fr', gap: 14, alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 3, position: 'sticky', top: 0 }}>
          ...
          {/* Toast preview panel */}
          {activeModule === 'toast' && (
            <div style={{ marginTop: 14, padding: '12px 10px', background: 'rgba(255,255,255,0.6)', borderRadius: 10, border: '0.5px solid rgba(193,198,215,0.4)' }}>
