...
export const appointmentRecords: AppointmentRecord[] = [
  ...
  { id: 'ap10', channelId: 'c1', channelName: 'Pacific Coast Insurance Group', channelNpn: 'NPN12348901', insurerId: '1', insurerName: 'Travelers', insurerShort: 'Travelers', state: 'WA', line: 'Auto', status: 'rejected', submittedDate: '2026-06-01', expiryDate: '', daysToExpiry: 0, submittedBy: 'Sarah Chen', rejectionReason: '申请人 WA 州牌照未激活，需先完成牌照激活' },
...
export const complianceReports: ComplianceReport[] = [
  { id: 'rp1', name: 'Appointment 状态月报 — 2026年8月', type: 'appointment-status', period: '2026-08', generatedDate: '2026-08-20 08:00', generatedBy: 'System Auto', status: 'ready', fileSize: '2.1 MB', recordCount: 124, format: 'Excel', recipients: ['compliance@company.com'] },
  ...
  { id: 'rp3', name: 'OFAC 筛查月度摘要 — 2026年8月', type: 'ofac-summary', period: '2026-08', generatedDate: '2026-08-21 16:45', generatedBy: 'System Auto', status: 'ready', fileSize: '0.9 MB', recordCount: 248, format: 'PDF' },
  ...
  { id: 'rp6', name: '监管申报报告 — 2026年8月', type: 'regulatory-filing', period: '2026-08', generatedDate: '', generatedBy: 'Scheduled', status: 'scheduled', format: 'PDF' },
]

export const REPORT_TYPE_LABEL: Record<string, string> = {
  'appointment-status': 'Appointment 状态', 'license-compliance': '牌照合规',
  'ofac-summary': 'OFAC 筛查摘要', 'interception-log': '合规拦截日志',
  'renewal-calendar': '续期日历', 'regulatory-filing': '监管申报',
}
