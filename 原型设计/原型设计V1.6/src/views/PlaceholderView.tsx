...
const VIEW_INFO: Record<string, { title: string; desc: string }> = {
  // Ch4 合规管理
  'appointment-tracking':       { title: 'Appointment 状态跟踪',  desc: '追踪各代理人 Appointment 申请进度、审批状态与历史变更记录。' },
  'appointment-renewal':        { title: 'Appointment 续期管理',  desc: '管理即将到期的 Appointment 续期登记、提醒与处理。' },
  'appointment-termination':    { title: 'Appointment 终止管理',  desc: '登记 Appointment 终止原因、终止日期及关联产品下架操作。' },
  'license-check':              { title: 'NIPR 牌照校验',         desc: '基于内部档案进行牌照合规核验，标注不一致项，待保司 API 开放后对接外部校验。' },
  'license-expiry-reminder':    { title: '牌照到期提醒',          desc: '展示即将到期牌照清单，支持批量提醒操作与续期登记。' },
  'compliance-interceptor':     { title: '出单合规拦截',          desc: '查看出单时触发合规拦截的记录日志，支持复核与例外处理。' },
  'compliance-rules':           { title: '合规规则配置',          desc: '配置各州/险种的合规检查规则，包含牌照要求、产品准入条件等。' },
  'compliance-report-generator':{ title: '合规报告生成',          desc: '按保司/州/时间维度生成合规状态报告，支持导出 PDF / Excel。' },
  'ofac-screening':             { title: 'OFAC 制裁筛查',         desc: '对保司、渠道、客户进行 OFAC SDN 名单筛查，记录结果与复核操作。' },
  cooperation: { title: '合作管理', desc: '管理我司与保险公司的合作关系、合同协议、结算参数、对接人、续约评估，以及向渠道的产品授权链路。' },
  finance: { title: '财务结算', desc: '处理保险公司佣金账单导入与解析、多维对账、差异处理、结算周期配置及保费对账。' },
