...
export interface CommissionBill {
  id: string
  fileName: string
  /** Primary insurer; leave empty string for multi-insurer batches */
  insurerId: string
  insurerName: string
  insurerShort: string
  /** Populated for multi-insurer batches */
  insurerIds?: string[]
  insurerShorts?: string[]
  period: string
  importDate: string
  importedBy: string
  fileSize: string
...
export const commissionBills: CommissionBill[] = [
  { id: 'cb1', fileName: 'Commission_Batch_202608_Multi.zip', insurerId: '', insurerName: '多家保险公司', insurerShort: '多家', insurerIds: ['1','2','3'], insurerShorts: ['Travelers','Liberty Mutual','Nationwide'], period: '2026-08', importDate: '2026-08-18 09:14:22', importedBy: 'System Auto', fileSize: '8.9 MB', fileFormat: 'CSV', status: 'reconciled', totalPolicies: 4839, totalPremium: 13209100, totalCommission: 1585068, parsedPolicies: 4839, matchedPolicies: 4816, exceptionCount: 23, reconciledAmount: 1582192, differenceAmount: 2876 },
...
export interface BillLineItem {
  ...
  diffAmount?: number
  diffNote?: string
  /** Insurer this line belongs to (populated for multi-insurer batches) */
  insurerId?: string
  insurerShort?: string
}
...
export const billLineItems: BillLineItem[] = [
  ...
  { id: 'li4', billId: 'cb1', lineNumber: 4, policyNumber: 'TRV-2026-0049188', insuredName: 'Summit Medical Group', channelId: 'c3', channelName: 'Great Lakes Insurance Partners', state: 'IL', line: 'Professional', effectiveDate: '2026-08-07', premium: 34600, commissionRate: 0.15, commissionAmount: 5190, ourPolicyNumber: undefined, ourCommissionRate: undefined, ourCommissionAmount: undefined, matchStatus: 'unmatched', diffNote: '系统中未找到匹配保单', insurerId: '1', insurerShort: 'Travelers' },
  { id: 'li5', billId: 'cb1', lineNumber: 5, policyNumber: 'TRV-2026-0049302', insuredName: 'Metro Construction LLC', channelId: 'c4', channelName: 'Empire State Insurance Services', state: 'NY', line: 'Commercial', effectiveDate: '2026-08-09', premium: 156700, commissionRate: 0.10, commissionAmount: 15670, ourPolicyNumber: 'INS-2026-0049302', ourCommissionRate: 0.10, ourCommissionAmount: 14800, matchStatus: 'amount-diff', diffAmount: 870, diffNote: '金额差异：账单 $15,670 vs 系统 $14,800（保费录入差异）', insurerId: '1', insurerShort: 'Travelers' },
  // cb1 — Liberty Mutual lines
  { id: 'li8', billId: 'cb1', lineNumber: 6, policyNumber: 'LM-2026-0073421', insuredName: 'Desert Solar Holdings', channelId: 'c9', channelName: 'Southwest Insurance Network', state: 'AZ', line: 'Commercial', effectiveDate: '2026-08-02', premium: 45200, commissionRate: 0.11, commissionAmount: 4972, ourPolicyNumber: 'INS-2026-0073421', ourCommissionRate: 0.11, ourCommissionAmount: 4972, matchStatus: 'matched', insurerId: '2', insurerShort: 'Liberty Mutual' },
  { id: 'li9', billId: 'cb1', lineNumber: 7, policyNumber: 'LM-2026-0073589', insuredName: 'Coastal Medical Associates', channelId: 'c5', channelName: 'Sunshine State Brokers', state: 'FL', line: 'Professional', effectiveDate: '2026-08-04', premium: 89600, commissionRate: 0.13, commissionAmount: 11648, ourPolicyNumber: 'INS-2026-0073589', ourCommissionRate: 0.13, ourCommissionAmount: 11648, matchStatus: 'matched', insurerId: '2', insurerShort: 'Liberty Mutual' },
  { id: 'li10', billId: 'cb1', lineNumber: 8, policyNumber: 'LM-2026-0074122', insuredName: 'Gulf Coast Petrochemical', channelId: 'c2', channelName: 'Lone Star Brokerage', state: 'TX', line: 'Commercial', effectiveDate: '2026-08-06', premium: 258600, commissionRate: 0.11, commissionAmount: 28446, ourPolicyNumber: 'INS-2026-0074122', ourCommissionRate: 0.10, ourCommissionAmount: 25860, matchStatus: 'rate-diff', diffAmount: 2586, diffNote: '费率差异：账单11% vs 系统10%', insurerId: '2', insurerShort: 'Liberty Mutual' },
  { id: 'li11', billId: 'cb1', lineNumber: 9, policyNumber: 'LM-2026-0074290', insuredName: 'Sunrise Healthcare', channelId: 'c3', channelName: 'Great Lakes Insurance Partners', state: 'IL', line: 'Professional', effectiveDate: '2026-08-08', premium: 98400, commissionRate: 0.13, commissionAmount: 12792, ourPolicyNumber: 'INS-2026-0074290', ourCommissionRate: 0.13, ourCommissionAmount: 12792, matchStatus: 'duplicate', insurerId: '2', insurerShort: 'Liberty Mutual' },
  // cb1 — Nationwide lines
  { id: 'li12', billId: 'cb1', lineNumber: 10, policyNumber: 'NW-2026-0034512', insuredName: 'Chicago Fleet Leasing', channelId: 'c3', channelName: 'Great Lakes Insurance Partners', state: 'IL', line: 'Commercial', effectiveDate: '2026-08-10', premium: 34100, commissionRate: 0.12, commissionAmount: 4092, ourPolicyNumber: 'INS-2026-0034512', ourCommissionRate: 0.12, ourCommissionAmount: 4092, matchStatus: 'matched', insurerId: '3', insurerShort: 'Nationwide' },
  { id: 'li13', billId: 'cb1', lineNumber: 11, policyNumber: 'NW-2026-0034788', insuredName: 'Mountain State Ventures', channelId: 'c7', channelName: 'Rocky Mountain Brokers', state: 'CO', line: 'P&C', effectiveDate: '2026-08-12', premium: 52800, commissionRate: 0.12, commissionAmount: 6336, ourPolicyNumber: 'INS-2026-0034788', ourCommissionRate: 0.12, ourCommissionAmount: 6336, matchStatus: 'matched', insurerId: '3', insurerShort: 'Nationwide' },
  { id: 'li14', billId: 'cb1', lineNumber: 12, policyNumber: 'NW-2026-0035001', insuredName: 'Pacific Northwest Timber', channelId: 'c8', channelName: 'Northwest Insurance Alliance', state: 'OR', line: 'Commercial', effectiveDate: '2026-08-14', premium: 78900, commissionRate: 0.10, commissionAmount: 7890, ourPolicyNumber: undefined, ourCommissionRate: undefined, ourCommissionAmount: undefined, matchStatus: 'unmatched', diffNote: '系统中保单已过期，疑为续保未登记', insurerId: '3', insurerShort: 'Nationwide' },
  // cb2 (single-insurer) — Liberty Mutual
