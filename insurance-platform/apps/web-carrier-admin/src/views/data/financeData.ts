// ── 财务与结算数据（自原型 financeData.ts 同步；中文自由文本均带 En 平行字段） ──
...
export const billLineItems: BillLineItem[] = [
  ...
  { id: 'li4', billId: 'cb1', lineNumber: 4, policyNumber: 'TRV-2026-0049188', insuredName: 'Summit Medical Group', channelId: 'c3', channelName: 'Great Lakes Insurance Partners', state: 'IL', line: 'Professional', effectiveDate: '2026-08-07', premium: 34600, commissionRate: 0.15, commissionAmount: 5190, matchStatus: 'unmatched', diffNote: '系统中未找到匹配保单', diffNoteEn: 'No matching policy found in the system' },
