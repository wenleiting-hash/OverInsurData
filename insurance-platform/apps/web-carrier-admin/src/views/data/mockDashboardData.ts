...
export interface InsuranceCarrier {
  ...
  coopStatus?: 'active' | 'expiring' | 'pending' | 'suspended' | string
  amBestRating?: string
...
export const insurers: InsuranceCarrier[] = [
  ...
  { carrierId: 'c1013', naicCode: '33445', carrierName: 'High Risk Coverage Specialists', shortName: 'HRC', type: 'Non-Admitted', status: 'pending', region: 'Midwest', lossRatio: 0.75, renewalRate: 0.75, revenue: 280000000, policyCount: 9500, commissionIncome: 3200000, coopStatus: 'pending', amBestRating: 'BB+', settlementCycle: 'Monthly', founded: 2015, website: 'www.highriskcoverage.com', coopType: 'wholesale', state: 'IL', spRating: 'BB+', moodysRating: 'Ba2', fitchRating: 'BBB-', contractExpiry: '2026-12-31', channelCount: 18, productCount: 3, lines: ['Specialty', 'E&S'] },
  ...
  { carrierId: 'c1020', naicCode: '00112', carrierName: 'UCO Insurance Company', shortName: 'UCO', type: 'Admitted', status: 'pending', region: 'Southeast', lossRatio: 0.63, renewalRate: 0.85, revenue: 380000000, policyCount: 15000, commissionIncome: 3800000, coopStatus: 'pending', amBestRating: 'A', settlementCycle: 'Quarterly', founded: 1974, website: 'www.ucoinsurance.com', coopType: 'independent', state: 'SC', spRating: 'A', moodysRating: 'A2', fitchRating: 'A', contractExpiry: '2026-12-31', channelCount: 24, productCount: 4, lines: ['Auto', 'Property'] },
