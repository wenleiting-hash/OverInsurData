...
// Synced from 设计原型V1.3 src/data/productDetails.ts, re-keyed to target productIds
// (p1001 Travelers Auto / p1006 Chubb Home / p1002 Chubb Enterprise).
...
export const ratePlans: RatePlan[] = [
  {
    id: 'rp1', productId: 'p1001', name: 'Standard Auto',
...
const channelCountFor = (code: string) => 3 + (code.charCodeAt(0) * 7 + code.charCodeAt(1) * 3) % 20
...
export const underwritingRules: UnderwritingRule[] = [
  {
    id: 'ur1', productId: 'p1001', name: '无驾照申请人拒保', nameEn: 'Decline Unlicensed Applicants',
  ...
  {
    id: 'ur2', productId: 'p1001', name: 'DUI 记录附加保费', nameEn: 'DUI Record Surcharge',
  ...
  {
    id: 'ur3', productId: 'p1001', name: '高价值车辆核保转介', nameEn: 'High-Value Vehicle Referral',
  ...
  {
    id: 'ur4', productId: 'p1001', name: '优良驾驶记录折扣', nameEn: 'Good Driver Discount',
  ...
  {
    id: 'ur5', productId: 'p1001', name: '商业用途车辆排除', nameEn: 'Commercial Use Exclusion',
  ...
  {
    id: 'ur6', productId: 'p1001', name: '新驾照低信用评分观察', nameEn: 'New Driver / Low Credit Score Review',
  ...
  {
    id: 'ur7', productId: 'p1002', name: 'MFA 缺失高风险标记', nameEn: 'MFA Gap High-Risk Flag',
  ...
  {
    id: 'ur8', productId: 'p1002', name: '医疗行业最高限额控制', nameEn: 'Healthcare Industry Limit Control',
...
export const trainingMaterials: TrainingMaterial[] = [
  {
    id: 'tm1', productId: 'p1001', title: 'Travelers Auto 产品指南 2026', titleEn: 'Travelers Auto Product Guide 2026',
  ...
  {
    id: 'tm2', productId: 'p1001', title: '费率手册 Q3 2026', titleEn: 'Rate Manual Q3 2026',
  ...
  {
    id: 'tm3', productId: 'p1001', title: '核保规则手册 v4.1', titleEn: 'Underwriting Rules Manual v4.1',
  ...
  {
    id: 'tm4', productId: 'p1001', title: '加州监管合规要求 2026', titleEn: 'California Regulatory Compliance Requirements 2026',
  ...
  {
    id: 'tm5', productId: 'p1001', title: '渠道培训课件 — 产品销售技巧', titleEn: 'Channel Training Deck — Product Sales Skills',
  ...
  {
    id: 'tm6', productId: 'p1001', title: '常见问题解答 FAQ v2.3', titleEn: 'Frequently Asked Questions v2.3',
  ...
  {
    id: 'tm7', productId: 'p1002', title: 'Chubb Cyber Enterprise 产品简介', titleEn: 'Chubb Cyber Enterprise Product Brief',
  ...
  {
    id: 'tm8', productId: 'p1002', title: '网络安全核保评估问卷', titleEn: 'Cyber Underwriting Assessment Questionnaire',
...
export function getProductPerf(productId: string): ProductPerformanceData[] {
  return productPerformance[productId] ?? productPerformance['p1001']
}
